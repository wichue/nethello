...
public:
    ...
    LogContext(bool bCR, LogLevel level, const char *file, const char *function, int line, const char *module_name, const char *flag);//chw
    ~LogContext() = default;
...
public:
    ...
    LogContextCapture(bool bCR, Logger &logger, LogLevel level, const char *file, const char *function, int line, const char *flag = "");//chw
...
public:
    ...
    //目前仅只有一处全局变量被外部引用，减少导出相关定义，导出以下函数避免导出kBroadcastLogEvent
...
#define WriteLNCR(level) ::chw::LogContextCapture(false,::chw::getLogger(), level, __FILE__, __FUNCTION__, __LINE__)//chw
#define InfoLNCR WriteLNCR(::chw::LInfo)//chw
#define TraceL WriteL(::chw::LTrace)
#define DebugL WriteL(::chw::LDebug)
#define InfoL WriteL(::chw::LInfo)
#define WarnL WriteL(::chw::LWarn)
#define ErrorL WriteL(::chw::LError)

//只能在虚继承BaseLogFlagInterface的类中使用
#define WriteF(level) ::chw::LogContextCapture(::chw::getLogger(), level, __FILE__, __FUNCTION__, __LINE__, getLogFlag())
#define TraceF WriteF(::chw::LTrace)
#define DebugF WriteF(::chw::LDebug)
#define InfoF WriteF(::chw::LInfo)
#define WarnF WriteF(::chw::LWarn)
...
#define LogL(level, ...) ::chw::LoggerWrapper::printLogArray(::chw::getLogger(), (LogLevel)level, __FILE__, __FUNCTION__, __LINE__, ##__VA_ARGS__)
#define LogT(...) LogL(::chw::LTrace, ##__VA_ARGS__)
#define LogD(...) LogL(::chw::LDebug, ##__VA_ARGS__)
#define LogI(...) LogL(::chw::LInfo, ##__VA_ARGS__)
#define LogW(...) LogL(::chw::LWarn, ##__VA_ARGS__)
#define LogE(...) LogL(::chw::LError, ##__VA_ARGS__)
